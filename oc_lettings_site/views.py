...
def index(request):
    ...
    Nullam elementum urna nisi, pellentesque iaculis enim cursus in. Praesent
...
def letting(request, letting_id):
    ...
    condimentum velit libero in magna. Suspendisse potenti. In tempus a nisi sed
    laoreet. Suspendisse porta dui eget sem accumsan interdum. Ut quis urna
